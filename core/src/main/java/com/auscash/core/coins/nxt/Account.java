package com.auscash.core.coins.nxt;
...
//                + " existing key " + com.onix.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.onix.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.onix.core.coins.nxt.Crypto.rsDecode(com.onix.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.onix.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.onix.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.onix.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.onix.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.onix.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.onix.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
